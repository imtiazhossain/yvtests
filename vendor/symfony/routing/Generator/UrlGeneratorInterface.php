 ...
 *
 * The src in this interface define the different types of resource references that
...
interface UrlGeneratorInterface extends RequestContextAwareInterface
{
     ...
     * @param int    $referenceType The type of reference to be generated (one of the src)
     *
