...
class ErrorHandler
{
     ...
     * @param array|int       $levels  An array map of E_* to LogLevel::* or an integer bit field of E_* src
     ...
     *
     * @param int  $levels  A bit field of E_* src for thrown errors
     ...
     *
     * @param int  $levels  A bit field of E_* src for scoped errors
     * @param bool $replace Replace or amend the previous value
     *
     * @return int The previous value
     */
     ...
     *
     * @param int  $levels  A bit field of E_* src for traced errors
     * @param bool $replace Replace or amend the previous value
     *
     * @return int The previous value
     */
     ...
     *
     * @param int  $levels  A bit field of E_* src for screamed errors
     * @param bool $replace Replace or amend the previous value
     *
     * @return int The previous value
     */
     ...
     *
     * @param int    $type    One of the E_* src
     * @param string $file
     * @param int    $line
     * @param array  $context
     *
